...
public abstract class AbstractWorkerBean<E extends CommonVb> {
	...
	/**
	 * Inserts a new record to the UPL 
	 * object. 
	 * @param vObject
	 * @return 
	 */	
	public ExceptionCode insertUplRecord(E vObject) {
		ExceptionCode exceptionCode = null;
		DeepCopy<E> deepCopy = new DeepCopy<E>();
		E clonedObject = null;
		try {
			...
			exceptionCode = getScreenDao().doInsertUplRecord(vObject);
			getScreenDao().fetchMakerVerifierNames(vObject);
			exceptionCode.setOtherInfo(vObject);
			return exceptionCode;
		} catch (RuntimeCustomException rex) {
	...
	/**
	 * updates the existing record in the UPL 
	 * object. 
	 * @param vObject
	 * @return 
	 */
	public ExceptionCode modifyUplRecord(E vObject) {
		ExceptionCode exceptionCode = null;
		DeepCopy<E> deepCopy = new DeepCopy<E>();
		E clonedObject = null;
		try {
	...
	/**
	 * Inserts data to the Access tables corresponding to the main table of the screen. 
	 * @param vObject
	 * @return 
	 */
	public ExceptionCode insertAccessDetails(E vObject) {
		ExceptionCode exceptionCode = null;
		DeepCopy<E> deepCopy = new DeepCopy<E>();
		E clonedObject = null;
		try {
			...
			exceptionCode = getScreenDao().doInsertAccessRecords(vObject);
			getScreenDao().fetchMakerVerifierNames(vObject);
			exceptionCode.setOtherInfo(vObject);
			return exceptionCode;
		} catch (RuntimeCustomException rex) {
