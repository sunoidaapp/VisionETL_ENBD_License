...
public class ReportFilterVb implements Serializable{
	...
	private String filter0Val = "";
	
	public String getFilter0Val() {
		return filter0Val;
	}
	public void setFilter0Val(String filter0Val) {
		this.filter0Val = filter0Val;
	}
